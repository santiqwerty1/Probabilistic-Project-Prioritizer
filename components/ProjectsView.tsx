...
interface ProjectsViewProps {
  ...
  onAdd: (project: MasterProject) => void;
  onUpdate: (project: MasterProject) => void;
  onDelete: (project: MasterProject) => void;
  onOpenScheduleEditor: (project: MasterProject) => void;
}

const ProjectsView: React.FC<ProjectsViewProps> = ({ projects, onAdd, onUpdate, onDelete, onOpenScheduleEditor }) => {
